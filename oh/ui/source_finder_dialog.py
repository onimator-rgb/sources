...
class SourceFinderDialog(QDialog):
    ...
    def _build_ui(self) -> None:
        ...
        self._select_all_btn.setToolTip("Select all accounts for discovery")
        self._select_all_btn.clicked.connect(self._on_select_all)
        select_lo.addWidget(self._select_all_btn)
        self._deselect_all_btn = QPushButton("Deselect All")
        self._deselect_all_btn.setMaximumWidth(100)
        self._deselect_all_btn.setToolTip("Deselect all accounts")
